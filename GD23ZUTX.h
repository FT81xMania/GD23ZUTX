...
#define SizeFT813       35  //NHD: 7-7",  5-5", 43-4.3", 35-3.5", Riverdi: 51-5", 71-7", MO: 52-5"
//*************** User editable line to select EVE TFT size
...
#define EVETFTonTeensyX    1  //1-->Yes accede a la EEPROM del T4  0-->No     0-->TFT´s from NHD 
#if (EVETFTonTeensyX==1)
  #include <EEPROM.h>
#endif
//Line under experimentation, don't modifffied
