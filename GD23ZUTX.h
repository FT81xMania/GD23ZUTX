...
//*************** User editable line to select STM32 MCU
     ...
     #define H743          1   //0 Nucleo-F767ZI    1  Nucleo-H743ZI 
  #endif
...
#if defined(ARDUINO_ARCH_STM32)
#define SetSPISpeed  48000000   //SPI1-->H743ZI    SPI1-->F767ZI
#endif

#ifdef TEENSYDUINO
 #if defined(__MK64FX512__) || defined(__MK66FX1M0__)
  #define SetSPISpeed  29000000  //F_BUS/3       29000000 (29 MHz) Teensy 3.6
 #endif
...
#define EVETFTonTeensyX    0  //1-->Access to the EEPROM on T4/T36  0-->TFT´s from NHD 
