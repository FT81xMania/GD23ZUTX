...
#ifndef _GD23ZUTX_H_INCLUDED
#define _GD23ZUTX_H_INCLUDED
...
#define POR_PIN     25  // POWER ON RESET SCREEN HOTMCU ONLY PWM pin is corect !!!       
                        // by lightcalamar
#define POR_INT     24
#define TFT_CS      10  // 
#define SD_PIN       5  // 
...
#define STM32_CPU     7670    //767--Nucleo F767ZI    429--F429I_DISCO  4071--M4DEMO_SDIO, Core7XXI_SDIO    4070--M4DEMO CON SPI2  7670--Nucleo F767ZI/H743ZI CoreOficial
//*************** User editable line to select STM32 MCU
...
#define SetSPISpeed  29000000  //F_BUS/3       29000000 (29 MHz) Teensy 3.6    47000000 (47 MHz) Teensy 4
//#define SetSPISpeed  20000000  //F_BUS/3      Teensy 3.6
//#define SetSPISpeed  F_BUS/3  //F_BUS/3       Teensy 3.6

//*************** User editable line to select EVE TFT size
#define SizeFT813       51  //NHD: 7-7",  5-5", 43-4.3", 35-3.5", Riverdi: 51-5", 71-7", MO: 52-5"BT815, MO: 53-5"FT813
//*************** User editable line to select EVE TFT size
...
#define EVETFTonTeensyX    1  //1-->Access to the EEPROM on T4/T36  0-->TFT´s from NHD 
