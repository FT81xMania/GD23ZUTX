...
// Use mySPI3 since SPI3 
static SPIClass mySPI3(PB2, PB4, PB3);
// Chip select PB21, dedicated SPI, 18 MHz, port 2.
#define SD_CONFIG SdSpiConfig(SD_CS_PIN, DEDICATED_SPI, SD_SCK_MHZ(18), &mySPI3)
SdFs sd;
FsFile file2;
...
if (Test==1)  
{
  ...
  GD.RestoreContext();
   ...
   sprintf(LoadTime, "Chip select pin: %d, Card size(MB): ", SD_CS_PIN);  
   GD.ColorRGB(0xff,0xff,0x00);   GD.cmd_text(10, 35, 18, 0, LoadTime); 
   GD.ColorRGB(0x00,0xff,0x00); GD.cmd_number(270, 43+18, 18, OPT_CENTER, 0.000512 * sdCardCapacity(&m_csd));
